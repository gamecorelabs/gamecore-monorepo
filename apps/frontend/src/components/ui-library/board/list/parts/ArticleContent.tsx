...
export const ArticleContent = ({
  ...
  return (
    <Link
      ...
      className="block transition rounded board-article-link"
    >
      <div className="flex items-center">
        <div>
          <span 
            className="inline-block mb-1 px-2 py-0.5 text-[0.6rem] rounded"
            style={{
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="flex items-center gap-2 ml-auto">
              <span className="flex items-center gap-1">
                ...
                <span className="text-xs" style={{ color: 'var(--text-muted)' }}>{post.like_count}</span>
              </span>
              <span className="flex items-center gap-1">
          ...
          <p className="text-sm line-clamp-3" style={{ color: 'var(--text-secondary)' }}>{post.content}</p>
        </div>
      </div>
    </Link>
  );
